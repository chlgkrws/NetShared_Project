...
public class MatchingMasterController implements Controller {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//파티장 신청
			...
			if(isPossibleRegister) {
				...
				insertWaitLeader(service, userId, netId, netPassword);
			//신청할 수 없다면 
			}else {
				HttpUtil.alertToJsp(request, response, "views/matching/normal_matching.jsp", "이미 신청하셨습니다.");
			}
	...
	//빠른 매칭 시 파티장 insert
	public void insertQuickWaitLeader(MatchingService service, String userId, String netId, String netPassword, int dcPercent, int maxNOM, int howLongUse) {
